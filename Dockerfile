# Ubuntu 14.04 LTS with WebRTC development environment.
# version 0.0.1
...
RUN apt-get update && apt-get -y install openjdk-7-jre openjdk-7-jdk openjdk-7-jre-headless
...
RUN apt-get install -y ca-certificates-java desktop-file-utils dosfstools \
  ...
  parted policykit-1-gnome sound-theme-freedesktop tzdata-java udisks2
